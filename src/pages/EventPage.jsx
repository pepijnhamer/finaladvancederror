...
export const EventPage = () => {
  ...
  const handleEditSubmit = async (formData) => {
    ...
    try {
      // Extract categoryIds from formData
      const { categoryIds, ...updatedFormData } = formData;

      // Update categoryIds in formData with checkedItems
      updatedFormData.categoryIds = checkedItems;
